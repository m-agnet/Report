...
この章では, 第\ref{sec:simulation}章において行ったシミュレーションに対して, それぞれ分析と考察をしていく. 適宜文脈に則した分析画像を提示するが, 入りきらない部分は付録\ref{ap:analysis}に収録する.
...
図\ref{fig:Ra0.70407675Rt0.5}$\text{R}_\text{a} = 0.469, \text{R}_\text{t} = 0.5$と図\ref{fig:Ra0.938769Rt0.5} $\text{R}_\text{a} = 0.938, \text{R}_\text{t} = 0.5$の間をもっと詳しく見る. 
