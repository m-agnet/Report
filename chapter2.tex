...
図\ref{fig:RaRtmap_time}, \ref{fig:RaRtmap_drop_time}, \ref{fig:dT0_time}, \ref{fig:g0_time}, \ref{fig:RaRtmap10_time}, \ref{fig{fig:qrs10_drop_time}}$t_i$の時点を赤直線で示すこととする.
