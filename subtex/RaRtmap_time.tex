\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{image/RaRtmap_time/2023-11-14T18:19:29.358__chi1.265_Ay50_rho0.4_T0.43_dT0.04_Rd0.0_Rt0.0_Ra0.0_g0.0003999718779659611_run4.0e7_output.png}
  \label{}
...
\begin{figure}[H]
  \begin{tabular}{ccccc}
    ...
    \end{minipage} 
  \end{tabular}
  \caption{$t \sqrt{\varepsilon / m \sigma^2}= 0.0から 2.0 \times 10^5, \dd t \sqrt{\varepsilon / m \sigma^2}= 0.005, t \sqrt{\varepsilon / m \sigma^2} = 200 ごとにプロット.$}
