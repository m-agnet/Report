% \begin{figure}[H]
%   \centering
%   \includegraphics[scale=0.6]{image/RaRtmap_time/2023-11-30T20:13:31.872_Ra_chi1.265_Ay50_rho0.4_T0.43_dT0.04_Rd0.0_Rt0.5_Ra0.5_g0.0003999718779659611_run1.2e9.png}
%   \caption{Ra0.4693845}
%   \label{}
% \end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{ccccc}
    ...
    \end{minipage} 
  \end{tabular}
  \caption{$t_i = 4.0 \times 10^4 , t_f = 6.0 \times 10^6, t\sqrt{\epsilon/m{\sigma}^2} = 50$ごとにプロット.}
  \label{}
\end{figure}