...
図\ref{fig:RaRtmap_time}, \ref{fig:RaRtmap_drop_time}, \ref{fig:dT0_time}, \ref{fig:g0_time}, \ref{fig:RaRtmap10_time}, \ref{fig:qrs10_drop_time}では重心位置の時間発展を示している.

また, 第\ref{chap:analysis}章で用いる$t_i$の時点がわかるように赤い直線を引くことにしている. 紙面上では画像が小さくなってしまうので, 各系ごとに拡大した画像を最初に示す. 
